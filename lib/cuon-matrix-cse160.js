 ...
 */
 ...
 class Vector3 {
  ...
  /**
   * Set the object's vector as the given vector src.
  ...
  static dot(other1, other2) {
    // NOTE: this algorithm takes inspiration from https://www.geeksforgeeks.org/program-dot-product-cross-product-two-vector/
    let product = 0;
    for (let i = 0; i < 3; i++)
      product = product + other1.elements[i] * other2.elements[i];
    return product;
  }
  ...
  /**
    ...
    */
  magnitude() {
    return Math.hypot(this.elements[0], this.elements[1], this.elements[2]);
  };
